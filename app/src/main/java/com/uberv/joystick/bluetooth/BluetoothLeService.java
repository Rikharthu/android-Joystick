...
public class BluetoothLeService extends Service {
    public static final String LOG_TAG = BluetoothLeService.class.getSimpleName();
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.example.uberv.bluetooth.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.example.uberv.bluetooth.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.example.uberv.bluetooth.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.example.uberv.bluetooth.ACTION_DATA_AVAILABLE";
    public final static String ACTION_DATA_WRITE =
            "com.example.uberv.bluetooth.ACTION_DATA_WRITE";
    public final static String EXTRA_DATA =
            "com.example.uberv.bluetooth.EXTRA_DATA";

    public final static UUID UUID_HM10 = UUID.fromString(GattAttributesContract.HM_10);
